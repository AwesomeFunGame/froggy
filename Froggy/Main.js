...
Elm.Froggy.Grid.make = function (_elm) {
   ...
   if (_elm.Froggy.Grid.values) return _elm.Froggy.Grid.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var translate = F2(function (a,b) {    return {x: a.x + b.x,y: a.y + b.y};});
   var equals = F2(function (a,b) {    return _U.eq(a.x,b.x) && _U.eq(a.y,b.y);});
   var Position = F2(function (a,b) {    return {x: a,y: b};});
   return _elm.Froggy.Grid.values = {_op: _op,Position: Position,equals: equals,translate: translate};
};
Elm.Native.Array = {};
...
Elm.Froggy.Util.make = function (_elm) {
   ...
   if (_elm.Froggy.Util.values) return _elm.Froggy.Util.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var distance = F2(function (a,b) {    return $Basics.abs(a - b);});
   var getOrElse = F2(function (defaultValue,maybeValue) {    return A2($Maybe.withDefault,defaultValue,maybeValue);});
   var remove = F2(function (xs,x) {    return A2($List.filter,function (element) {    return !_U.eq(element,x);},xs);});
   return _elm.Froggy.Util.values = {_op: _op,remove: remove,getOrElse: getOrElse,distance: distance};
};
Elm.Froggy = Elm.Froggy || {};
...
Elm.Froggy.TransitionUtil.make = function (_elm) {
   ...
   if (_elm.Froggy.TransitionUtil.values) return _elm.Froggy.TransitionUtil.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var time = A2($Signal.map,$Basics.fst,$Time.timestamp($Time.fps(30)));
   var TransitionInfo = F2(function (a,b) {    return {oldValue: a,startTime: b};});
   return _elm.Froggy.TransitionUtil.values = {_op: _op,TransitionInfo: TransitionInfo,time: time};
};
Elm.Froggy = Elm.Froggy || {};
...
Elm.Froggy.Levels.make = function (_elm) {
   ...
   if (_elm.Froggy.Levels.values) return _elm.Froggy.Levels.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var level0 = {frogPosition: {x: 6,y: 1}
                ,leafMatrix: _U.list([_U.list([false,false,false,false,true,false,false,false])
                                     ,_U.list([false,true,true,true,true,true,true,false])
                                     ,_U.list([false,true,false,false,true,false,false,false])
                                     ,_U.list([false,true,false,false,true,false,false,false])
                                     ,_U.list([true,true,false,false,true,true,true,false])
                                     ,_U.list([true,false,false,false,false,false,true,false])
                                     ,_U.list([true,true,true,true,true,true,true,false])
                                     ,_U.list([false,false,false,false,false,false,false,false])])
                ,levelPosition: {x: $Basics.round(6),y: $Basics.round(0)}
                ,keyboardHintPosition: {x: $Basics.round(0),y: $Basics.round(0)}};
   var levels = $Array.fromList(_U.list([level0
                                        ,{frogPosition: {x: 5,y: 2}
                                         ,leafMatrix: _U.list([_U.list([true,false,false,false,false,false,false,false])
                                                              ,_U.list([true,true,true,true,false,false,false,false])
                                                              ,_U.list([true,false,false,false,true,true,true,false])
                                                              ,_U.list([true,false,false,false,false,false,false,false])
                                                              ,_U.list([true,false,true,true,true,false,false,false])
                                                              ,_U.list([false,false,false,true,false,false,false,false])
                                                              ,_U.list([true,true,true,true,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 5,y: 3}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 5,y: 3}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,true,false,false])
                                                              ,_U.list([false,false,true,false,true,true,true,false])
                                                              ,_U.list([false,false,false,false,false,true,false,false])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,true,true,true,false,true,false,false])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 0,y: 2}
                                         ,leafMatrix: _U.list([_U.list([true,false,false,false,false,false,false,false])
                                                              ,_U.list([true,false,true,false,true,false,true,false])
                                                              ,_U.list([true,false,false,false,true,false,true,false])
                                                              ,_U.list([false,false,false,false,true,false,true,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([true,true,true,true,false,false,false,false])
                                                              ,_U.list([false,false,false,false,true,true,true,false])
                                                              ,_U.list([false,false,false,true,true,true,true,false])])
                                         ,levelPosition: {x: 0,y: 3}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 4,y: 4}
                                         ,leafMatrix: _U.list([_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,true,true,true,false,false,false,false])
                                                              ,_U.list([false,false,true,false,true,false,false,false])
                                                              ,_U.list([false,true,false,false,true,false,true,false])
                                                              ,_U.list([true,true,false,true,true,true,true,false])
                                                              ,_U.list([false,true,false,false,false,false,true,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 7,y: 0}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 5,y: 3}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,true,false,true,false,false])
                                                              ,_U.list([false,false,false,true,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,true,true,false])
                                                              ,_U.list([false,false,true,true,true,true,false,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([false,true,false,true,false,false,false,false])
                                                              ,_U.list([false,false,false,true,false,true,true,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 0,y: 3}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 1,y: 0}
                                         ,leafMatrix: _U.list([_U.list([false,true,false,false,false,false,false,false])
                                                              ,_U.list([true,true,true,false,true,false,true,false])
                                                              ,_U.list([false,false,false,true,false,true,true,false])
                                                              ,_U.list([false,false,false,true,false,false,true,false])
                                                              ,_U.list([false,true,true,true,true,true,false,false])
                                                              ,_U.list([false,true,false,true,false,true,true,false])
                                                              ,_U.list([false,false,false,false,false,true,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 7,y: 7}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 3,y: 3}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,true,true,true,false])
                                                              ,_U.list([false,true,false,true,false,false,true,false])
                                                              ,_U.list([false,true,true,true,true,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([false,false,true,true,true,true,false,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([false,false,false,false,false,true,true,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 6,y: 0}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,true,true,true,true,false])
                                                              ,_U.list([false,true,true,false,false,false,false,false])
                                                              ,_U.list([false,false,false,true,true,true,false,false])
                                                              ,_U.list([true,false,true,false,true,false,true,false])
                                                              ,_U.list([true,true,true,false,true,false,false,false])
                                                              ,_U.list([true,false,false,false,false,false,true,false])
                                                              ,_U.list([true,false,true,false,false,false,false,false])
                                                              ,_U.list([true,false,true,false,true,true,true,true])])
                                         ,levelPosition: {x: 7,y: 0}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 6,y: 2}
                                         ,leafMatrix: _U.list([_U.list([false,true,true,true,false,true,false,true])
                                                              ,_U.list([false,false,false,false,true,true,false,false])
                                                              ,_U.list([false,true,false,false,true,false,true,true])
                                                              ,_U.list([false,false,true,false,false,true,false,true])
                                                              ,_U.list([true,true,true,false,true,false,true,false])
                                                              ,_U.list([true,false,true,false,false,true,false,false])
                                                              ,_U.list([true,true,true,true,true,false,true,false])
                                                              ,_U.list([false,false,false,true,false,true,false,false])])
                                         ,levelPosition: {x: 0,y: 1}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 6,y: 1}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([false,true,false,false,false,false,true,false])
                                                              ,_U.list([false,true,false,false,true,true,true,false])
                                                              ,_U.list([true,true,false,false,true,true,false,false])
                                                              ,_U.list([false,true,false,false,true,false,false,false])
                                                              ,_U.list([false,false,true,true,false,true,false,false])
                                                              ,_U.list([true,true,true,false,false,false,false,false])
                                                              ,_U.list([true,false,true,false,false,false,false,false])])
                                         ,levelPosition: {x: 7,y: 7}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 5,y: 3}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,true,false,true,false,false])
                                                              ,_U.list([false,true,false,true,true,true,true,true])
                                                              ,_U.list([false,true,false,true,false,true,false,false])
                                                              ,_U.list([true,true,true,false,false,true,false,true])
                                                              ,_U.list([false,true,false,false,true,true,true,true])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,false,false,true,true,true,false,false])
                                                              ,_U.list([false,false,true,false,true,false,false,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 6,y: 2}
                                         ,leafMatrix: _U.list([_U.list([false,false,true,false,true,true,false,true])
                                                              ,_U.list([false,false,true,false,false,true,false,true])
                                                              ,_U.list([false,false,true,true,true,false,true,false])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([false,false,false,true,false,true,true,true])
                                                              ,_U.list([false,false,true,false,true,false,true,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 0,y: 7}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 6,y: 2}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,true,false,false,false])
                                                              ,_U.list([true,true,true,false,true,false,false,true])
                                                              ,_U.list([false,false,true,true,true,true,true,true])
                                                              ,_U.list([false,true,false,false,false,false,false,false])
                                                              ,_U.list([true,true,true,false,true,false,false,true])
                                                              ,_U.list([false,true,false,true,true,false,true,true])
                                                              ,_U.list([false,false,false,false,true,false,false,false])
                                                              ,_U.list([false,true,true,false,true,false,true,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 1,y: 6}
                                         ,leafMatrix: _U.list([_U.list([true,false,true,false,true,false,false,true])
                                                              ,_U.list([false,false,true,false,false,false,false,false])
                                                              ,_U.list([true,false,true,false,true,false,true,true])
                                                              ,_U.list([false,true,true,true,false,true,true,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([true,false,false,true,true,false,false,false])
                                                              ,_U.list([true,true,false,false,true,false,true,false])
                                                              ,_U.list([true,false,true,true,true,false,false,false])])
                                         ,levelPosition: {x: 7,y: 7}
                                         ,keyboardHintPosition: {x: 7,y: 6}}
                                        ,{frogPosition: {x: 4,y: 6}
                                         ,leafMatrix: _U.list([_U.list([true,false,true,true,true,true,true,false])
                                                              ,_U.list([true,false,true,false,true,false,false,false])
                                                              ,_U.list([false,true,false,true,true,true,false,true])
                                                              ,_U.list([true,false,true,false,true,false,true,false])
                                                              ,_U.list([false,true,false,false,true,false,false,true])
                                                              ,_U.list([true,false,true,true,true,false,true,false])
                                                              ,_U.list([true,true,false,false,true,false,false,true])
                                                              ,_U.list([true,false,false,true,false,true,false,true])])
                                         ,levelPosition: {x: 7,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 1}}
                                        ,{frogPosition: {x: 4,y: 2}
                                         ,leafMatrix: _U.list([_U.list([true,true,true,false,true,false,false,false])
                                                              ,_U.list([false,false,false,true,true,true,false,false])
                                                              ,_U.list([false,true,false,false,true,false,false,false])
                                                              ,_U.list([false,true,false,true,true,true,false,false])
                                                              ,_U.list([true,true,false,false,true,false,false,false])
                                                              ,_U.list([false,true,false,false,true,false,false,false])
                                                              ,_U.list([false,true,false,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 4,y: 7}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 4,y: 7}
                                         ,leafMatrix: _U.list([_U.list([true,true,true,true,true,true,true,true])
                                                              ,_U.list([true,false,false,false,true,false,false,true])
                                                              ,_U.list([true,false,true,false,true,false,false,true])
                                                              ,_U.list([true,false,false,false,true,true,true,true])
                                                              ,_U.list([true,false,false,false,false,false,false,true])
                                                              ,_U.list([true,false,true,false,false,true,false,true])
                                                              ,_U.list([true,false,false,false,false,false,false,true])
                                                              ,_U.list([true,true,true,true,true,true,true,true])])
                                         ,levelPosition: {x: 3,y: 4}
                                         ,keyboardHintPosition: {x: 2,y: 4}}
                                        ,{frogPosition: {x: 3,y: 5}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,false,false,false])
                                                              ,_U.list([false,true,true,true,true,false,false,true])
                                                              ,_U.list([true,false,true,false,false,false,false,true])
                                                              ,_U.list([true,true,false,false,false,true,false,true])
                                                              ,_U.list([true,false,true,false,false,true,false,false])
                                                              ,_U.list([false,true,true,true,false,true,false,true])
                                                              ,_U.list([false,false,false,false,false,true,false,false])
                                                              ,_U.list([false,false,true,false,true,true,true,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 4,y: 4}
                                         ,leafMatrix: _U.list([_U.list([false,false,true,false,true,false,false,false])
                                                              ,_U.list([false,false,true,false,false,true,true,false])
                                                              ,_U.list([false,false,false,false,true,false,false,false])
                                                              ,_U.list([true,true,true,true,false,false,true,false])
                                                              ,_U.list([false,false,false,false,true,false,false,false])
                                                              ,_U.list([false,false,false,true,false,false,true,false])
                                                              ,_U.list([false,false,false,true,true,true,true,false])
                                                              ,_U.list([false,false,false,false,true,false,true,false])])
                                         ,levelPosition: {x: 7,y: 4}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 4,y: 3}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,true,true,true])
                                                              ,_U.list([false,false,false,true,false,true,true,false])
                                                              ,_U.list([true,true,true,true,true,false,false,false])
                                                              ,_U.list([false,true,false,true,true,false,true,false])
                                                              ,_U.list([false,false,false,false,false,true,true,false])
                                                              ,_U.list([false,false,false,false,false,false,true,false])
                                                              ,_U.list([false,true,false,true,true,true,true,false])
                                                              ,_U.list([true,true,true,false,true,false,false,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 1,y: 6}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,true,false,true])
                                                              ,_U.list([false,false,false,false,false,true,false,true])
                                                              ,_U.list([false,false,false,false,false,true,true,true])
                                                              ,_U.list([false,false,false,true,true,true,false,false])
                                                              ,_U.list([false,false,false,true,false,true,false,false])
                                                              ,_U.list([false,true,false,true,false,true,false,true])
                                                              ,_U.list([true,true,true,false,true,false,false,false])
                                                              ,_U.list([false,true,false,false,true,true,false,true])])
                                         ,levelPosition: {x: 0,y: 7}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 0,y: 7}
                                         ,leafMatrix: _U.list([_U.list([true,true,true,true,false,true,false,true])
                                                              ,_U.list([false,false,false,false,false,true,true,true])
                                                              ,_U.list([false,false,true,true,false,false,true,false])
                                                              ,_U.list([false,false,false,false,true,true,true,false])
                                                              ,_U.list([true,true,false,true,false,true,false,false])
                                                              ,_U.list([false,false,true,false,true,true,false,false])
                                                              ,_U.list([true,false,false,false,false,false,false,false])
                                                              ,_U.list([true,true,true,true,true,false,false,false])])
                                         ,levelPosition: {x: 7,y: 7}
                                         ,keyboardHintPosition: {x: 6,y: 7}}
                                        ,{frogPosition: {x: 2,y: 6}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,false,false,false])
                                                              ,_U.list([false,true,false,true,false,true,false,true])
                                                              ,_U.list([true,false,true,true,true,false,true,true])
                                                              ,_U.list([false,true,false,true,false,false,false,true])
                                                              ,_U.list([true,false,true,false,false,false,true,false])
                                                              ,_U.list([false,false,false,false,true,false,true,false])
                                                              ,_U.list([false,true,true,true,true,false,true,false])
                                                              ,_U.list([false,true,false,false,false,false,true,false])])
                                         ,levelPosition: {x: 4,y: 0}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 7,y: 0}
                                         ,leafMatrix: _U.list([_U.list([true,true,true,true,false,true,true,true])
                                                              ,_U.list([false,false,false,true,false,true,false,false])
                                                              ,_U.list([false,false,false,true,false,true,false,false])
                                                              ,_U.list([true,true,true,true,false,true,true,true])
                                                              ,_U.list([true,false,false,false,false,false,false,true])
                                                              ,_U.list([true,false,false,false,false,false,false,true])
                                                              ,_U.list([true,true,true,true,false,true,true,true])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 4,y: 4}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 5,y: 3}
                                         ,leafMatrix: _U.list([_U.list([true,false,true,false,true,false,false,false])
                                                              ,_U.list([true,true,false,true,true,true,false,true])
                                                              ,_U.list([false,false,false,false,true,false,false,true])
                                                              ,_U.list([false,false,false,true,true,true,false,false])
                                                              ,_U.list([false,false,false,false,true,false,false,true])
                                                              ,_U.list([false,false,false,true,false,false,false,true])
                                                              ,_U.list([false,true,true,true,false,true,false,true])
                                                              ,_U.list([false,false,true,true,true,false,false,true])])
                                         ,levelPosition: {x: 0,y: 3}
                                         ,keyboardHintPosition: {x: 7,y: 0}}
                                        ,{frogPosition: {x: 4,y: 7}
                                         ,leafMatrix: _U.list([_U.list([false,false,false,false,false,true,true,true])
                                                              ,_U.list([false,false,false,false,false,true,false,false])
                                                              ,_U.list([false,false,false,true,false,false,true,false])
                                                              ,_U.list([false,false,false,true,false,true,true,false])
                                                              ,_U.list([false,false,true,true,true,false,true,true])
                                                              ,_U.list([false,true,false,false,false,false,true,false])
                                                              ,_U.list([true,true,true,false,false,false,true,true])
                                                              ,_U.list([false,true,true,true,true,false,false,false])])
                                         ,levelPosition: {x: 0,y: 0}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 3,y: 5}
                                         ,leafMatrix: _U.list([_U.list([true,false,true,false,true,false,true,true])
                                                              ,_U.list([false,true,false,true,false,true,false,true])
                                                              ,_U.list([true,false,true,false,true,false,false,false])
                                                              ,_U.list([false,true,false,true,false,true,true,true])
                                                              ,_U.list([false,true,true,false,true,false,true,false])
                                                              ,_U.list([true,true,true,true,false,false,true,false])
                                                              ,_U.list([false,true,false,false,false,false,false,false])
                                                              ,_U.list([false,false,false,false,false,false,false,false])])
                                         ,levelPosition: {x: 6,y: 7}
                                         ,keyboardHintPosition: {x: 7,y: 7}}
                                        ,{frogPosition: {x: 5,y: 5}
                                         ,leafMatrix: _U.list([_U.list([false,true,false,true,true,false,true,false])
                                                              ,_U.list([true,true,false,false,false,false,false,false])
                                                              ,_U.list([true,false,true,true,false,true,false,true])
                                                              ,_U.list([false,false,true,false,true,false,true,false])
                                                              ,_U.list([true,false,false,true,false,true,false,true])
                                                              ,_U.list([true,false,true,true,false,true,true,true])
                                                              ,_U.list([true,false,false,true,false,true,false,false])
                                                              ,_U.list([false,false,true,false,true,true,false,false])])
                                         ,levelPosition: {x: 7,y: 7}
                                         ,keyboardHintPosition: {x: 0,y: 0}}
                                        ,{frogPosition: {x: 7,y: 0}
                                         ,leafMatrix: _U.list([_U.list([true,true,true,true,true,true,true,true])
                                                              ...
                                                              ,_U.list([true,true,true,true,true,true,true,true])
                                                              ,_U.list([true,true,true,true,true,true,true,true])
                                                              ,_U.list([false,true,true,true,true,true,true,true])])
                                         ,levelPosition: {x: 0,y: 7}
                                         ,keyboardHintPosition: {x: 7,y: 0}}]));
   var numberOfLevels = $Array.length(levels);
   var getLevel = function (levelNumber) {    return A2($Maybe.withDefault,level0,A2($Array.get,levelNumber,levels));};
   var Level = F4(function (a,b,c,d) {    return {frogPosition: a,leafMatrix: b,levelPosition: c,keyboardHintPosition: d};});
   return _elm.Froggy.Levels.values = {_op: _op,Level: Level,level0: level0,levels: levels,getLevel: getLevel,numberOfLevels: numberOfLevels};
};
Elm.Froggy = Elm.Froggy || {};
...
Elm.Froggy.Model.make = function (_elm) {
   ...
   if (_elm.Froggy.Model.values) return _elm.Froggy.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Froggy$Grid = Elm.Froggy.Grid.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var near = F2(function (a,b) {    return _U.cmp(A2($Froggy$Util.distance,a,b),2) < 1;});
   var angleBetween = F2(function (sourceLeaf,targetLeaf) {
      ...
      return _U.eq(sourceX,targetX) && (_U.cmp(sourceY,targetY) > 0 && A2(near,sourceY,targetY)) ? $Maybe.Just(90) : _U.eq(sourceY,targetY) && (_U.cmp(sourceX,
      targetX) < 0 && A2(near,sourceX,targetX)) ? $Maybe.Just(0) : _U.eq(sourceX,targetX) && (_U.cmp(sourceY,targetY) < 0 && A2(near,
      sourceY,
      targetY)) ? $Maybe.Just(270) : _U.eq(sourceY,targetY) && (_U.cmp(sourceX,targetX) > 0 && A2(near,sourceX,targetX)) ? $Maybe.Just(180) : $Maybe.Nothing;
   });
   var angleOf = function (frog) {
      var _p0 = frog.lastMove;
      if (_p0.ctor === "Just") {
            return A2($Froggy$Util.getOrElse,0,A2(angleBetween,_p0._0.oldValue,frog.leaf));
         } else {
            return 90;
         }
   };
   var reachableBy = F2(function (frog,leaf) {    return $Maybe$Extra.isJust(A2(angleBetween,frog.leaf,leaf));});
   var onlyDoubleJump = function (scene) {
      var distanceY = function (leaf) {    return A2($Froggy$Util.distance,scene.frog.leaf.position.y,leaf.position.y);};
      var distanceX = function (leaf) {    return A2($Froggy$Util.distance,scene.frog.leaf.position.x,leaf.position.x);};
      var leafOnlyDoubleJump = function (leaf) {    return _U.eq(distanceX(leaf),2) || _U.eq(distanceY(leaf),2);};
      return A2($List.all,leafOnlyDoubleJump,A2($List.filter,reachableBy(scene.frog),scene.leaves));
   };
   var stuck = function (scene) {    return $Basics.not(A2($List.any,reachableBy(scene.frog),scene.leaves));};
   var levelCompleted = function (scene) {    return _U.eq($List.length(scene.leaves),1);};
   var Leaf = function (a) {    return {position: a};};
   var Frog = F2(function (a,b) {    return {leaf: a,lastMove: b};});
   var Scene = F3(function (a,b,c) {    return {frog: a,leaves: b,levelNumber: c};});
   var Game = F3(function (a,b,c) {    return {scene: a,usingKeyboard: b,lastSceneChange: c};});
   return _elm.Froggy.Model.values = {_op: _op
                                     ,Game: Game
                                     ,Scene: Scene
                                     ,Frog: Frog
                                     ,Leaf: Leaf
...
Elm.Froggy.Commands.make = function (_elm) {
   ...
   if (_elm.Froggy.Commands.values) return _elm.Froggy.Commands.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Froggy$Grid = Elm.Froggy.Grid.make(_elm),
   ...
   var updateStart = F2(function (loadedGame,startGame) {
      var _p0 = startGame;
      if (_p0.ctor === "Nop") {
   ...
   var makeMoveBy = F2(function (shift,arrows) {    var multiplier = shift ? 2 : 1;return MoveBy({x: arrows.x * multiplier,y: (0 - arrows.y) * multiplier});});
   var Nop = {ctor: "Nop"};
   var moveTo = $Signal.mailbox(Nop);
   var makeCommand = F2(function (command,pressed) {    return pressed ? command : Nop;});
   var makeStart = function (loadedGame) {    return $Signal.dropRepeats(A3($Signal.foldp,updateStart,Nop,loadedGame));};
   var commands = function (loadedGame) {
      var start = makeStart(loadedGame);
      var restartLevel = A2($Signal.map,makeCommand(RestartLevel),$Keyboard.isDown(27));
      var $continue = A2($Signal.map,makeCommand(Continue),A2($Signal.merge,$Keyboard.enter,$Mouse.isDown));
      var moveBy = A3($Signal.map2,makeMoveBy,$Keyboard.shift,$Keyboard.arrows);
      return $Time.timestamp($Signal.mergeMany(_U.list([moveBy,moveTo.signal,$continue,restartLevel,start])));
   };
   return _elm.Froggy.Commands.values = {_op: _op
                                        ,Nop: Nop
                                        ,MoveBy: MoveBy
                                        ,MoveTo: MoveTo
                                        ,Continue: Continue
...
Elm.Froggy.State.make = function (_elm) {
   ...
   if (_elm.Froggy.State.values) return _elm.Froggy.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var loadLeafRow = F2(function (y,row) {
      var removeValue = function (leaf) {    return {position: {x: leaf.position.x,y: leaf.position.y}};};
      var isThere = function (_p0) {    var _p1 = _p0;return _p1.value;};
      var make = F2(function (x,value) {    return {position: {x: x,y: y},value: value};});
      return A2($List.map,removeValue,A2($List.filter,isThere,A2($List.indexedMap,make,row)));
   });
   var loadLeafMatrix = function (leafMatrix) {    return $List.concat(A2($List.indexedMap,loadLeafRow,leafMatrix));};
   var findLeaf = F2(function (position,leaves) {
      var hasPosition = function (leaf) {    return A2($Froggy$Grid.equals,leaf.position,position);};
      return A2($Array.get,0,$Array.fromList(A2($List.filter,hasPosition,leaves)));
   });
   var loadLevel = F3(function (time,oldScene,levelNumber) {
      var actualLevelNumber = _U.cmp(levelNumber,$Froggy$Levels.numberOfLevels) > -1 || _U.cmp(levelNumber,0) < 0 ? 0 : levelNumber;
      var level = $Froggy$Levels.getLevel(actualLevelNumber);
      var leaves = loadLeafMatrix(level.leafMatrix);
      var maybeLeaf = A2(findLeaf,level.frogPosition,leaves);
      var leaf = A2($Maybe.withDefault,A2($Maybe.withDefault,{position: {x: 0,y: 0}},$List.head(leaves)),maybeLeaf);
      return {scene: {frog: {leaf: leaf,lastMove: $Maybe.Nothing},leaves: leaves,levelNumber: actualLevelNumber}
             ,usingKeyboard: false
             ,lastSceneChange: $Maybe.Just({oldValue: oldScene,startTime: time})};
   });
   var nextLevel = F2(function (time,game) {    return A3(loadLevel,time,$Maybe.Just(game.scene),game.scene.levelNumber + 1);});
   var restartLevel = F2(function (time,game) {    return A3(loadLevel,time,$Maybe.Just(game.scene),game.scene.levelNumber);});
   var $continue = F2(function (time,game) {
      return $Froggy$Model.levelCompleted(game.scene) ? A2(nextLevel,time,game) : $Froggy$Model.stuck(game.scene) ? A2(restartLevel,time,game) : game;
   });
   var newGame = F2(function (time,lastSceneChange) {
      var level0 = A3(loadLevel,time,$Maybe.Nothing,0);
      return _U.update(level0,{lastSceneChange: lastSceneChange});
   });
   var initialGame = A2(newGame,0,$Maybe.Nothing);
   var start = F2(function (loadedGame,time) {
      var lastSceneChange = $Maybe.Just({oldValue: $Maybe.Nothing,startTime: time});
      var _p2 = loadedGame;
      if (_p2.ctor === "Nothing") {
            return A2(newGame,time,lastSceneChange);
         } else {
            return _U.update(_p2._0,{lastSceneChange: lastSceneChange});
         }
   });
   var useKeyboard = F2(function (keyboard,game) {    return _U.update(game,{usingKeyboard: keyboard});});
   var moveTo = F3(function (leaf,time,game) {
      var scene = game.scene;
      var reachable = A2($Froggy$Model.reachableBy,game.scene.frog,leaf);
      var newGame = reachable ? _U.update(game,
      {scene: _U.update(scene,
      {frog: {leaf: leaf,lastMove: $Maybe.Just({oldValue: game.scene.frog.leaf,startTime: time})}
      ,leaves: A2($Froggy$Util.remove,game.scene.leaves,game.scene.frog.leaf)})}) : game;
      return A2(useKeyboard,false,newGame);
   });
   var moveBy = F3(function (positionDelta,time,game) {
      var newGame = function () {
         if (_U.eq(positionDelta.x,0) && _U.eq(positionDelta.y,0)) return game; else {
               var leafPosition = A2($Froggy$Grid.translate,game.scene.frog.leaf.position,positionDelta);
               var maybeLeaf = A2(findLeaf,leafPosition,game.scene.leaves);
               var _p3 = maybeLeaf;
               if (_p3.ctor === "Nothing") {
                     return game;
                  } else {
                     return A3(moveTo,_p3._0,time,game);
                  }
            }
      }();
      return A2(useKeyboard,true,newGame);
   });
   var update = F2(function (_p4,game) {
      var _p5 = _p4;
      var _p7 = _p5._0;
      var _p6 = _p5._1;
      switch (_p6.ctor)
      {case "Nop": return game;
         case "MoveBy": return A3(moveBy,_p6._0,_p7,game);
         case "MoveTo": return A3(moveTo,_p6._0,_p7,game);
         case "Continue": return A2($continue,_p7,game);
         case "RestartLevel": return A2(restartLevel,_p7,game);
         default: return A2(start,_p6._0,_p7);}
   });
   var game = function (loadedGame) {    return A3($Signal.foldp,update,initialGame,$Froggy$Commands.commands(loadedGame));};
   return _elm.Froggy.State.values = {_op: _op
                                     ,game: game
                                     ,update: update
...
Elm.Froggy.View.make = function (_elm) {
   ...
   if (_elm.Froggy.View.values) return _elm.Froggy.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var viewCover = F3(function (_p0,time,lastSceneChange) {
      var _p1 = _p0;
      var easingFunction = $Maybe$Extra.isJust(lastSceneChange.oldValue) ? $Easing.retour($Easing.linear) : $Easing.flip($Easing.linear);
      var factor = A6($Easing.ease,easingFunction,$Easing.$float,0,1,sceneChangeDuration,time - lastSceneChange.startTime);
      return A2($Graphics$Element.opacity,factor,A2($Graphics$Element.color,$Color.black,A2($Graphics$Element.spacer,_p1._0,_p1._1)));
   });
   var imagePath = function (filename) {    return A2($Basics._op["++"],"images/",filename);};
   var gameText = F3(function (fontName,height,string) {
      return $Graphics$Element.centered(A2($Text.style,
      {typeface: _U.list([fontName]),height: $Maybe.Just(height),color: $Color.red,bold: true,italic: false,line: $Maybe.Nothing},
      $Text.fromString(string)));
   });
   var makeForm = F2(function (worldPosition,element) {    return A2($Graphics$Collage.move,worldPosition,$Graphics$Collage.toForm(element));});
   var customSprite = F4(function (transform,worldPosition,tileSize,url) {
      var element = A3($Graphics$Element.image,$Basics.round(tileSize),$Basics.round(tileSize),url);
      return A2(makeForm,worldPosition,transform(element));
   });
   var sprite = customSprite($Basics.identity);
   var moveDuration = 250 * $Time.millisecond;
   var mapSize = 8;
   var toWorld = F2(function (tileSize,position) {
      var transform = function (coordinate) {    return ($Basics.toFloat(coordinate) - mapSize / 2 + 0.5) * tileSize;};
      return {ctor: "_Tuple2",_0: transform(position.x),_1: 0 - transform(position.y)};
   });
   var viewLeaf = F2(function (tileSize,leaf) {
      var worldPosition = A2(toWorld,tileSize,leaf.position);
      return A3(sprite,worldPosition,tileSize,imagePath("leaf.png"));
   });
   var viewFrog = F3(function (tileSize,time,frog) {
      var size = function () {
         var _p2 = frog.lastMove;
         if (_p2.ctor === "Nothing") {
               return 1;
            } else {
               return A6($Easing.ease,$Easing.retour($Easing.easeInQuad),$Easing.$float,1,1.2,moveDuration,time - _p2._0.startTime);
            }
      }();
      var lastLeaf = function () {
         var _p3 = frog.lastMove;
         if (_p3.ctor === "Nothing") {
               return _U.list([]);
            } else {
               var alphaValue = A6($Easing.ease,$Easing.easeInCubic,$Easing.$float,1,0,moveDuration,time - _p3._0.startTime);
               return _U.list([A2($Graphics$Collage.alpha,alphaValue,A2(viewLeaf,tileSize,_p3._0.oldValue))]);
            }
      }();
      var newWorldPosition = A2(toWorld,tileSize,frog.leaf.position);
      var worldPosition = function () {
         var _p4 = frog.lastMove;
         if (_p4.ctor === "Just") {
               var oldWorldPosition = A2(toWorld,tileSize,_p4._0.oldValue.position);
               ...
               newWorldPosition,
               moveDuration,
               time - _p4._0.startTime);
            } else {
               return newWorldPosition;
            }
      }();
      var frogSprite = A2($Graphics$Collage.scale,
      size,
      A2($Graphics$Collage.rotate,$Basics.degrees($Basics.toFloat($Froggy$Model.angleOf(frog))),A3(sprite,worldPosition,tileSize,imagePath("frog.png"))));
      return A2($Basics._op["++"],lastLeaf,_U.list([frogSprite]));
   });
   var viewTargets = F3(function (frog,tileSize,leaves) {
      var worldPosition = function (target) {    return A2(toWorld,tileSize,target.position);};
      var angleOf = function (target) {    return A2($Froggy$Util.getOrElse,0,A2($Froggy$Model.angleBetween,frog.leaf,target));};
      var distanceOf = function (target) {
         return A2($Froggy$Util.distance,target.position.x,frog.leaf.position.x) + A2($Froggy$Util.distance,target.position.y,frog.leaf.position.y);
      };
      var filename = function (target) {
         return imagePath(A2($Basics._op["++"],
         "arrows/",
         A2($Basics._op["++"],$Basics.toString(distanceOf(target)),A2($Basics._op["++"],"/",A2($Basics._op["++"],$Basics.toString(angleOf(target)),".svg")))));
      };
      var toClickable = function (target) {
         return $Graphics$Input.clickable(A2($Signal.message,$Froggy$Commands.moveTo.address,$Froggy$Commands.MoveTo(target)));
      };
      var viewTarget = function (target) {    return A4(customSprite,toClickable(target),worldPosition(target),tileSize,filename(target));};
      var targets = A2($List.filter,$Froggy$Model.reachableBy(frog),leaves);
      return A2($List.map,viewTarget,targets);
   });
   var textSprite = F4(function (fontName,position,tileSize,string) {
      var worldPosition = A2(toWorld,tileSize,position);
      var textSize = tileSize / 5;
      return A2(makeForm,worldPosition,A3(gameText,fontName,textSize,string));
   });
   var viewLevelNumber = F3(function (fontName,tileSize,levelNumber) {
      var position = function (_) {    return _.levelPosition;}($Froggy$Levels.getLevel(levelNumber));
      var worldPosition = A2(toWorld,tileSize,position);
      var background = A3(sprite,worldPosition,tileSize,imagePath("level.png"));
      var indicator = A2($Graphics$Collage.rotate,
      $Basics.degrees(-1),
      A4(textSprite,
      fontName,
      position,
      ...
      A2($Basics._op["++"],
      "Level\n",
      A2($Basics._op["++"],$Basics.toString(levelNumber),A2($Basics._op["++"],"/",$Basics.toString($Froggy$Levels.numberOfLevels - 1))))));
      return _U.list([background,indicator]);
   });
   var viewMessage = F4(function (fontName,tileSize,time,scene) {
      var scaleFactor = function () {
         var _p5 = scene.frog.lastMove;
         if (_p5.ctor === "Just") {
               return A6($Easing.ease,$Easing.easeInOutBack,$Easing.$float,0,1,moveDuration * 2,time - _p5._0.startTime);
            } else {
               return 1;
            }
      }();
      var iconSize = tileSize / 2.5;
      var inverseAngle = $Basics.toFloat(A2($Basics._op["%"],$Froggy$Model.angleOf(scene.frog) + 180,360));
      ...
      var position = A2($Froggy$Grid.translate,scene.frog.leaf.position,{x: deltaX,y: deltaY});
      var worldPosition = A2(toWorld,tileSize,position);
      var filename = imagePath(A2($Basics._op["++"],"message/",A2($Basics._op["++"],$Basics.toString(inverseAngle),".svg")));
      var background = A3(sprite,worldPosition,tileSize,filename);
      var forms = function () {
         if ($Froggy$Model.levelCompleted(scene)) {
               var lastLevel = _U.eq(scene.levelNumber,$Froggy$Levels.numberOfLevels - 1);
               return lastLevel ? _U.list([background,A3(sprite,worldPosition,iconSize,imagePath("completed.svg"))]) : _U.list([background
                                                                                                                               ,A3(sprite,
                                                                                                                               worldPosition,
                                                                                                                               iconSize,
                                                                                                                               imagePath("next.png"))]);
            } else if ($Froggy$Model.stuck(scene)) return _U.list([background,A3(sprite,worldPosition,iconSize,imagePath("restart.png"))]);
            else return _U.list([]);
      }();
      return A2($List.map,$Graphics$Collage.scale(scaleFactor),forms);
   });
   var getTileSize = function (viewSize) {    return $Basics.toFloat(viewSize) / mapSize;};
   var viewKeyboardHint = F4(function (fontName,viewSize,time,game) {
      if (game.usingKeyboard) {
            var scaleFactor = function () {
               var _p6 = game.scene.frog.lastMove;
               if (_p6.ctor === "Just") {
                     return A6($Easing.ease,$Easing.easeInOutQuad,$Easing.$float,0,1,moveDuration,time - _p6._0.startTime);
                  } else {
                     return 1;
                  }
            }();
            var gridPosition = function (_) {    return _.keyboardHintPosition;}($Froggy$Levels.getLevel(game.scene.levelNumber));
            var tileSize = getTileSize(viewSize);
            var worldPosition = A2(toWorld,tileSize,gridPosition);
            var background = A3(sprite,worldPosition,tileSize,imagePath("key.svg"));
            var text = function (string) {    return A4(textSprite,fontName,gridPosition,tileSize,string);};
            var forms = $Froggy$Model.levelCompleted(game.scene) && _U.eq(game.scene.levelNumber,0) ? _U.list([background
                                                                                                              ,text("Enter")]) : $Froggy$Model.stuck(game.scene) && $Basics.not($Froggy$Model.levelCompleted(game.scene)) ? _U.list([background
                                                                                                                                                                                                                                    ,text("Esc")]) : $Froggy$Model.onlyDoubleJump(game.scene) && _U.eq(game.scene.levelNumber,
            0) ? _U.list([background,text("Shift")]) : _U.list([]);
            return A2($List.map,$Graphics$Collage.scale(scaleFactor),forms);
         } else return _U.list([]);
   });
   var viewScene = F5(function (fontName,viewSize,time,lastSceneChange,scene) {
      var tileSize = getTileSize(viewSize);
      var actualScene = function () {
         var _p7 = lastSceneChange.oldValue;
         if (_p7.ctor === "Just") {
               return _U.cmp(time - lastSceneChange.startTime,sceneChangeDuration / 2) < 0 ? _p7._0 : scene;
            } else {
               return scene;
            }
      }();
      var frog = A3(viewFrog,tileSize,time,actualScene.frog);
      var leaves = A2($List.map,viewLeaf(tileSize),actualScene.leaves);
      var targets = A3(viewTargets,actualScene.frog,tileSize,actualScene.leaves);
      var level = A3(viewLevelNumber,fontName,tileSize,actualScene.levelNumber);
      var message = A4(viewMessage,fontName,tileSize,time,actualScene);
      return A3($Graphics$Collage.collage,
      viewSize,
      viewSize,
      A2($Basics._op["++"],leaves,A2($Basics._op["++"],targets,A2($Basics._op["++"],frog,A2($Basics._op["++"],level,message)))));
   });
   var view = F4(function (fontName,_p8,time,game) {
      var _p9 = _p8;
      var _p13 = _p9._0;
      var _p12 = _p9._1;
      var _p10 = game.lastSceneChange;
      if (_p10.ctor === "Just") {
            var _p11 = _p10._0;
            var cover = A3(viewCover,{ctor: "_Tuple2",_0: _p13,_1: _p12},time,_p11);
            var viewSize = A2($Basics.min,_p13,_p12);
            var scene = A5(viewScene,fontName,viewSize,time,_p11,game.scene);
            var keyboardHint = A3($Graphics$Collage.collage,viewSize,viewSize,A4(viewKeyboardHint,fontName,viewSize,time,game));
            return $Graphics$Element.layers(A2($List.map,
            A3($Graphics$Element.container,_p13,_p12,$Graphics$Element.middle),
            _U.list([scene,keyboardHint,cover])));
         } else {
            var loadingImage = A4($Graphics$Element.container,_p13,_p12,$Graphics$Element.middle,A3($Graphics$Element.image,64,64,imagePath("loading.gif")));
            var blackRectangle = A2($Graphics$Element.color,$Color.black,A2($Graphics$Element.spacer,_p13,_p12));
            return $Graphics$Element.layers(_U.list([blackRectangle,loadingImage]));
         }
   });
   return _elm.Froggy.View.values = {_op: _op
                                    ,view: view
                                    ,viewScene: viewScene
...
Elm.Froggy.Main.make = function (_elm) {
   ...
   if (_elm.Froggy.Main.values) return _elm.Froggy.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Froggy$Model = Elm.Froggy.Model.make(_elm),
   ...
   var _op = {};
   var fontName = Elm.Native.Port.make(_elm).inbound("fontName",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var loadedGame = Elm.Native.Port.make(_elm).inboundSignal("loadedGame",
   "Maybe.Maybe Froggy.Model.Game",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "scene" in v && "usingKeyboard" in v && "lastSceneChange" in v ? {_: {}
                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                           ,frog: typeof v.scene.frog === "object" && "leaf" in v.scene.frog && "lastMove" in v.scene.frog ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                             ,leaf: typeof v.scene.frog.leaf === "object" && "position" in v.scene.frog.leaf ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ,position: typeof v.scene.frog.leaf.position === "object" && "x" in v.scene.frog.leaf.position && "y" in v.scene.frog.leaf.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ,x: typeof v.scene.frog.leaf.position.x === "number" && isFinite(v.scene.frog.leaf.position.x) && Math.floor(v.scene.frog.leaf.position.x) === v.scene.frog.leaf.position.x ? v.scene.frog.leaf.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     v.scene.frog.leaf.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ,y: typeof v.scene.frog.leaf.position.y === "number" && isFinite(v.scene.frog.leaf.position.y) && Math.floor(v.scene.frog.leaf.position.y) === v.scene.frog.leaf.position.y ? v.scene.frog.leaf.position.y : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     v.scene.frog.leaf.position.y)} : _U.badPort("an object with fields `x`, `y`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               v.scene.frog.leaf.position)} : _U.badPort("an object with fields `position`",
                                                                                                                                                                                                                                                                                                                                                                                             v.scene.frog.leaf)
                                                                                                                                                                                                                                                                                                                                                                                             ,lastMove: v.scene.frog.lastMove === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.scene.frog.lastMove === "object" && "oldValue" in v.scene.frog.lastMove && "startTime" in v.scene.frog.lastMove ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,oldValue: typeof v.scene.frog.lastMove.oldValue === "object" && "position" in v.scene.frog.lastMove.oldValue ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,position: typeof v.scene.frog.lastMove.oldValue.position === "object" && "x" in v.scene.frog.lastMove.oldValue.position && "y" in v.scene.frog.lastMove.oldValue.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ,x: typeof v.scene.frog.lastMove.oldValue.position.x === "number" && isFinite(v.scene.frog.lastMove.oldValue.position.x) && Math.floor(v.scene.frog.lastMove.oldValue.position.x) === v.scene.frog.lastMove.oldValue.position.x ? v.scene.frog.lastMove.oldValue.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          v.scene.frog.lastMove.oldValue.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ,y: typeof v.scene.frog.lastMove.oldValue.position.y === "number" && isFinite(v.scene.frog.lastMove.oldValue.position.y) && Math.floor(v.scene.frog.lastMove.oldValue.position.y) === v.scene.frog.lastMove.oldValue.position.y ? v.scene.frog.lastMove.oldValue.position.y : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          v.scene.frog.lastMove.oldValue.position.y)} : _U.badPort("an object with fields `x`, `y`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.scene.frog.lastMove.oldValue.position)} : _U.badPort("an object with fields `position`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.scene.frog.lastMove.oldValue)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,startTime: typeof v.scene.frog.lastMove.startTime === "number" ? v.scene.frog.lastMove.startTime : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.scene.frog.lastMove.startTime)} : _U.badPort("an object with fields `oldValue`, `startTime`",
                                                                                                                                                                                                                                                                                                                                                                                             v.scene.frog.lastMove))} : _U.badPort("an object with fields `leaf`, `lastMove`",
                                                                                                                                                                                                                                                                                           v.scene.frog)
                                                                                                                                                                                                                                                                                           ,leaves: typeof v.scene.leaves === "object" && v.scene.leaves instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.scene.leaves.map(function (v) {
                                                                                                                                                                                                                                                                                              return typeof v === "object" && "position" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                ,position: typeof v.position === "object" && "x" in v.position && "y" in v.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                      ,x: typeof v.position.x === "number" && isFinite(v.position.x) && Math.floor(v.position.x) === v.position.x ? v.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                      v.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                      ,y: typeof v.position.y === "number" && isFinite(v.position.y) && Math.floor(v.position.y) === v.position.y ? v.position.y : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                      v.position.y)} : _U.badPort("an object with fields `x`, `y`",
                                                                                                                                                                                                                                                                                                                                                v.position)} : _U.badPort("an object with fields `position`",
                                                                                                                                                                                                                                                                                              v);
                                                                                                                                                                                                                                                                                           })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                           v.scene.leaves)
                                                                                                                                                                                                                                                                                           ,levelNumber: typeof v.scene.levelNumber === "number" && isFinite(v.scene.levelNumber) && Math.floor(v.scene.levelNumber) === v.scene.levelNumber ? v.scene.levelNumber : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                           v.scene.levelNumber)} : _U.badPort("an object with fields `frog`, `leaves`, `levelNumber`",
                                                                                                                                                                             v.scene)
                                                                                                                                                                             ,usingKeyboard: typeof v.usingKeyboard === "boolean" ? v.usingKeyboard : _U.badPort("a boolean (true or false)",
                                                                                                                                                                             v.usingKeyboard)
                                                                                                                                                                             ,lastSceneChange: v.lastSceneChange === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.lastSceneChange === "object" && "oldValue" in v.lastSceneChange && "startTime" in v.lastSceneChange ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                    ,oldValue: v.lastSceneChange.oldValue === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.lastSceneChange.oldValue === "object" && "frog" in v.lastSceneChange.oldValue && "leaves" in v.lastSceneChange.oldValue && "levelNumber" in v.lastSceneChange.oldValue ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ,frog: typeof v.lastSceneChange.oldValue.frog === "object" && "leaf" in v.lastSceneChange.oldValue.frog && "lastMove" in v.lastSceneChange.oldValue.frog ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,leaf: typeof v.lastSceneChange.oldValue.frog.leaf === "object" && "position" in v.lastSceneChange.oldValue.frog.leaf ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,position: typeof v.lastSceneChange.oldValue.frog.leaf.position === "object" && "x" in v.lastSceneChange.oldValue.frog.leaf.position && "y" in v.lastSceneChange.oldValue.frog.leaf.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ,x: typeof v.lastSceneChange.oldValue.frog.leaf.position.x === "number" && isFinite(v.lastSceneChange.oldValue.frog.leaf.position.x) && Math.floor(v.lastSceneChange.oldValue.frog.leaf.position.x) === v.lastSceneChange.oldValue.frog.leaf.position.x ? v.lastSceneChange.oldValue.frog.leaf.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  v.lastSceneChange.oldValue.frog.leaf.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ,y: typeof v.lastSceneChange.oldValue.frog.leaf.position.y === "number" && isFinite(v.lastSceneChange.oldValue.frog.leaf.position.y) && Math.floor(v.lastSceneChange.oldValue.frog.leaf.position.y) === v.lastSceneChange.oldValue.frog.leaf.position.y ? v.lastSceneChange.oldValue.frog.leaf.position.y : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  v.lastSceneChange.oldValue.frog.leaf.position.y)} : _U.badPort("an object with fields `x`, `y`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.lastSceneChange.oldValue.frog.leaf.position)} : _U.badPort("an object with fields `position`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.lastSceneChange.oldValue.frog.leaf)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,lastMove: v.lastSceneChange.oldValue.frog.lastMove === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.lastSceneChange.oldValue.frog.lastMove === "object" && "oldValue" in v.lastSceneChange.oldValue.frog.lastMove && "startTime" in v.lastSceneChange.oldValue.frog.lastMove ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ,oldValue: typeof v.lastSceneChange.oldValue.frog.lastMove.oldValue === "object" && "position" in v.lastSceneChange.oldValue.frog.lastMove.oldValue ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ,position: typeof v.lastSceneChange.oldValue.frog.lastMove.oldValue.position === "object" && "x" in v.lastSceneChange.oldValue.frog.lastMove.oldValue.position && "y" in v.lastSceneChange.oldValue.frog.lastMove.oldValue.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,x: typeof v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x === "number" && isFinite(v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x) && Math.floor(v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x) === v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x ? v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,y: typeof v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y === "number" && isFinite(v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y) && Math.floor(v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y) === v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y ? v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.lastSceneChange.oldValue.frog.lastMove.oldValue.position.y)} : _U.badPort("an object with fields `x`, `y`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             v.lastSceneChange.oldValue.frog.lastMove.oldValue.position)} : _U.badPort("an object with fields `position`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       v.lastSceneChange.oldValue.frog.lastMove.oldValue)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ,startTime: typeof v.lastSceneChange.oldValue.frog.lastMove.startTime === "number" ? v.lastSceneChange.oldValue.frog.lastMove.startTime : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       v.lastSceneChange.oldValue.frog.lastMove.startTime)} : _U.badPort("an object with fields `oldValue`, `startTime`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.lastSceneChange.oldValue.frog.lastMove))} : _U.badPort("an object with fields `leaf`, `lastMove`",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                v.lastSceneChange.oldValue.frog)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ,leaves: typeof v.lastSceneChange.oldValue.leaves === "object" && v.lastSceneChange.oldValue.leaves instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.lastSceneChange.oldValue.leaves.map(function (v) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   return typeof v === "object" && "position" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ,position: typeof v.position === "object" && "x" in v.position && "y" in v.position ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,x: typeof v.position.x === "number" && isFinite(v.position.x) && Math.floor(v.position.x) === v.position.x ? v.position.x : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.position.x)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                v.lastSceneChange.oldValue.leaves)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ,levelNumber: typeof v.lastSceneChange.oldValue.levelNumber === "number" && isFinite(v.lastSceneChange.oldValue.levelNumber) && Math.floor(v.lastSceneChange.oldValue.levelNumber) === v.lastSceneChange.oldValue.levelNumber ? v.lastSceneChange.oldValue.levelNumber : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                v.lastSceneChange.oldValue.levelNumber)} : _U.badPort("an object with fields `frog`, `leaves`, `levelNumber`",
                                                                                                                                                                                                                                                                                                                                                                                                    v.lastSceneChange.oldValue))
                                                                                                                                                                                                                                                                                                                                                                                                    ,startTime: typeof v.lastSceneChange.startTime === "number" ? v.lastSceneChange.startTime : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                    v.lastSceneChange.startTime)} : _U.badPort("an object with fields `oldValue`, `startTime`",
                                                                                                                                                                             v.lastSceneChange))} : _U.badPort("an object with fields `scene`, `usingKeyboard`, `lastSceneChange`",
      v));
   });
   var mainState = $Froggy$State.game(loadedGame);
   var savedGame = Elm.Native.Port.make(_elm).outboundSignal("savedGame",
   function (v) {
      return {scene: {frog: {leaf: {position: {x: v.scene.frog.leaf.position.x,y: v.scene.frog.leaf.position.y}}
                     ...
                     ,leaves: Elm.Native.List.make(_elm).toArray(v.scene.leaves).map(function (v) {    return {position: {x: v.position.x,y: v.position.y}};})
             ...
             ,lastSceneChange: v.lastSceneChange.ctor === "Nothing" ? null : {oldValue: v.lastSceneChange._0.oldValue.ctor === "Nothing" ? null : {frog: {leaf: {position: {x: v.lastSceneChange._0.oldValue._0.frog.leaf.position.x
                                                                                                                                                  ...
                                                                                                                                                  ,leaves: Elm.Native.List.make(_elm).toArray(v.lastSceneChange._0.oldValue._0.leaves).map(function (v) {
   ...
   mainState);
   var main = A4($Signal.map3,$Froggy$View.view(fontName),$Window.dimensions,$Froggy$TransitionUtil.time,mainState);
   return _elm.Froggy.Main.values = {_op: _op,main: main,mainState: mainState};
};
